...
while True:
    ...
    for i, detection in enumerate(detections):
        ...
        if class_id == 0:  # Verifica se a classe detectada é 'person'
            ...
            if first_person_id is None:
                ...
                # Após definir o ID da primeira pessoa, já estamos rastreando ela
                person_tracked = True
            ...
            if person_id == first_person_id:
                ...
                # Definir limites para os valores de delta
                ...
                # Não precisa procurar mais uma vez; já estamos rastreando a primeira pessoa
                break
